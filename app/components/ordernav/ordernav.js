    ...
    return (
        <div className='px-3'>
            <div className='  flex items-center justify-between p-2 shadow-sm sticky'>
                <div>
                    <h1 className='text-xl tablet:text-2xl laptop:text-4xl text-gray-900 border-b-2 border-neutral-300 font-Caveat'>Frexxie Foods</h1>
                </div>
                        ...
                        <div className='text-gray-700 '>
                            <ul onClick={closeClickHandler} className=' flex flex-col gap-y-3 font-Poppins  text-xl w-full'>
                                ...
                                <div className='flex items-center hover:bg-emerald-200 gap-x-2 cursor-pointer'>
                                    ...
                                    <Link href="/contact"><li className='text-small block'>Contacts</li></Link>
                                </div>
                                ...
                                <div className='flex items-center hover:bg-emerald-200 gap-x-2 cursor-pointer'>
                                    ...
                                    <Link href="/about"><li className='text-small block'>About Us</li></Link></div>
