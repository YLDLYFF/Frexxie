...
export default class ContactForm extends Component {
  render () {
    return (
      <div className="absolute top-16 tablet:relative flex-none font-Poppins tablet:w-full px-6 bg-sky-50 bg-opacity-5">
        <div className='flex flex-col tablet:flex-row '>
          ...
          <div className='image w-full laptop:p-28 rounded-b-md tablet:rounded-r-md shadow-md'>
            <div className='flex flex-col items-center justify-center text-gray-50'>
            
              <h1 className='text-xl tablet:text-3xl laptop:text-7xl font-Caveat'>Frexxie Foods</h1>
              <p>Lorem ipsum dolor sit amet elit. Eligendi, officia excepturi. Illum distinctio distinctio!</p>
            </div>
          </div>
        </div>
      </div>
