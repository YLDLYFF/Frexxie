  ...
  return (
    <div className='fixed top-0 w-full bg-homeDefaultNav dark:bg-homeDefaultDark  shadow-md p-4 md:px-6'>
      ...
      { isOpen == false ?
        ...
        :
        <div className='overflow-x-hidden  border-l fixed w-[100%] h-dvh bg-white text-gray-700 dark:bg-homeDefaultDark translate-x-[140px] transition duration-[1.1s] scroll-m-0 shadow-sm tablet:hidden'>
          <div>

            <div className='text-gray-700 '>
              <ul onClick={ closeClickHandler } className=' flex flex-col gap-y-3 font-Poppins text-xl w-full dark:text-white '>
